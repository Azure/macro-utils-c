...
int run_mu_eat_empty_args_test(void)
{
    ...
    { /*scope because of repetitive naure of tests and copy&paste*/
        ...
        POOR_MANS_ASSERT_AND_RETURN(1 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(42 + 1 == testerArray[0]);
    }
    ...
    { /*scope because of repetitive naure of tests and copy&paste*/
        ...
        POOR_MANS_ASSERT_AND_RETURN(1 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(42 + 2 == testerArray[0]);
    }
    
    {
        int testerArray[] = { MU_EAT_EMPTY_ARGS(42 + 3 ,42 + 4) }; /*doesn't eat anything*/

        POOR_MANS_ASSERT_AND_RETURN(2 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 42 + 3);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[1] == 42 + 4);
    }
    ...
    /*see that it eats / doesn't eat from 3 arguments*/
    {
        ...
        POOR_MANS_ASSERT_AND_RETURN(3 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 42 + 5);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[1] == 42 + 6);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[2] == 42 + 7);
    }
    ...
    /*see that it eats / doesn't eat from 3 arguments*/
    {
        ...
        POOR_MANS_ASSERT_AND_RETURN(2 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 42 + 6);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[1] == 42 + 7);
    }
    ...
    /*see that it eats / doesn't eat from 3 arguments*/
    {
        ...
        POOR_MANS_ASSERT_AND_RETURN(1 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 42 + 7);
    }
    ...
    /*see that it eats / doesn't eat from 10 arguments*/
    {
        ...
        POOR_MANS_ASSERT_AND_RETURN(10 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 1);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[1] == 2);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[2] == 3);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[3] == 4);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[4] == 5);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[5] == 6);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[6] == 7);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[7] == 8);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[8] == 9);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[9] == 10);
    }
    ...
    /*see that it eats / doesn't eat from 10 arguments*/
    {
        ...
        POOR_MANS_ASSERT_AND_RETURN(9 == (sizeof(testerArray) / sizeof(testerArray[0])));
        POOR_MANS_ASSERT_AND_RETURN(testerArray[0] == 1);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[1] == 2);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[2] == 4);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[3] == 5);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[4] == 6);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[5] == 7);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[6] == 8);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[7] == 9);
        POOR_MANS_ASSERT_AND_RETURN(testerArray[8] == 10);
    }
