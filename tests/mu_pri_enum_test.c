...
int run_mu_pri_enum_tests(void)
{
    ...
    /*test that MU_ENUM_VALUE is "",someString,someInt*/
    POOR_MANS_ASSERT(verifyMU_ENUM_VALUE_X2(MU_ENUM_VALUE(TEST_PRI_ENUM_2, X2)) == 0);
    POOR_MANS_ASSERT(verifyMU_ENUM_VALUE_ZY2(MU_ENUM_VALUE(TEST_PRI_ENUM_2, ZY2)) == 0);
    POOR_MANS_ASSERT(verifyMU_ENUM_VALUE_1(MU_ENUM_VALUE(TEST_PRI_ENUM_2, (TEST_PRI_ENUM_2)(1))) == 0);
    POOR_MANS_ASSERT(verifyMU_ENUM_VALUE_3(MU_ENUM_VALUE(TEST_PRI_ENUM_2, (TEST_PRI_ENUM_2)(3))) == 0);
    POOR_MANS_ASSERT(verifyMU_ENUM_VALUE_7(MU_ENUM_VALUE(TEST_PRI_ENUM_2, (TEST_PRI_ENUM_2)(7))) == 0);

    /*test that PRI_MU_ENUM and MU_ENUM_VALUE work together in printf*/
    (void)printf("%" PRI_MU_ENUM "\n", MU_ENUM_VALUE(TEST_PRI_ENUM_2, ZY2));
